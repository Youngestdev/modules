#Build SYSTEMIC dynamic module for LINUX
#
...
#
#user $ cd modules/dynamic_modules/systemic/
#
...
#
#simple/src/makefiles/systemic/ $ make -f Makefile-Linux.mk
...
${CND_DISTDIR}/${CND_PLATFORM}/systemic.${CND_DLIB_EXT}: $(OBJECTFILES)
	$(CC) $(LFlAGS) -shared -o $(CND_DISTDIR)/$(CND_PLATFORM)/systemic.$(CND_DLIB_EXT) $(OBJECTFILES) $(LDLIBSOPTIONS) -shared
