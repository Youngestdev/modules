...
${OBJECTDIR}/includes/arraylist.o: includes/arraylist.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/includes/arraylist.o includes/arraylist.c

${OBJECTDIR}/includes/debug.o: includes/debug.c
	${MKDIR} -p ${OBJECTDIR}/includes
	${RM} "$@.d"
	$(COMPILE.c) -g  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/includes/debug.o includes/debug.c

${OBJECTDIR}/includes/json_object.o: includes/json_object.c
	${MKDIR} -p ${OBJECTDIR}/includes
	${RM} "$@.d"
	$(COMPILE.c) -g  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/includes/json_object.o includes/json_object.c

${OBJECTDIR}/includes/json_tokener.o: includes/json_tokener.c
	${MKDIR} -p ${OBJECTDIR}/includes
	${RM} "$@.d"
	$(COMPILE.c) -g  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/includes/json_tokener.o includes/json_tokener.c

${OBJECTDIR}/includes/json_util.o: includes/json_util.c
	${MKDIR} -p ${OBJECTDIR}/includes
	${RM} "$@.d"
	$(COMPILE.c) -g  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/includes/json_util.o includes/json_util.c

${OBJECTDIR}/includes/linkhash.o: includes/linkhash.c
	${MKDIR} -p ${OBJECTDIR}/includes
	${RM} "$@.d"
	$(COMPILE.c) -g  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/includes/linkhash.o includes/linkhash.c
